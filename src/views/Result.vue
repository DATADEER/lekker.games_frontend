    ...
    <section class="bg-black h-screen overflow-hidden">
      ...
      <div class="flex">
        ...
        <main class="w-full md:w-1/2 flex flex-col justify-center items-center">
          <h1 class="text-white font-title tracking-wider mb-12   ">
            Your new favorite game
          </h1>
          <span class="font-sans font-bold text-orange-dark py-2 px-2"
            >RANDOM MOCKED RESULT</span
          >
          <a
            target="_blank"
            v-bind:href="
              `https://store.steampowered.com/app/${finalGame.appid}/`
            "
          >
              ...
              <img
                ...
                v-lazy="
                  convertSteamImageHashToUrl(
                    finalGame.appid,
                    finalGame.img_logo_url
                  )
                "
              />
              <h2
                class="text-black font-subtitle text-center text-xs p-4 tracking-wider"
              >
                {{ finalGame.name }}
              </h2>
            </div>
