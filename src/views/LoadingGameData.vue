        ...
        <section class="bg-black h-screen overflow-hidden">
            ...
            <div class="flex">
                ...
                <main class="w-full md:w-1/2 flex flex-col justify-center items-center">
                    <div class="text-white font-subtitle text-xl md:text-4xl mx-6 mb-6">LOADING GAME DATA</div>
                    <meme-message class="w-auto">
                        <component :is="currentMessageComponent" :message="currentMessageText"></component>
                    </meme-message>
                </main>
                <aside class="display-none md:w-1/4">
    ...
    export default {
        ...
        data() {
            return {
                ...
                currentMessageText:"Please stand by i am collecting all the necessary game data to give you a recommendation",
                iconFilenames: [
        ...
        methods: {
            ...
            checkIfAllGamesAreCollected(userID){
                ...
                requestInterval$
                    .switchMap(() => {
                        return Rx.Observable.fromPromise(this.areAllGameCollectedRequest(userID));
                    })
                    .subscribe(
                        (result) => {
                            ...
                            if(result.collectionIsComplete){
                                ...
                                console.log("gamesAlreadyCollected",status.gamesAlreadyCollected);
